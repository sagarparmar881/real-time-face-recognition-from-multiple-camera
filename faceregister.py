# Tkinter GUI / Face register GUI with tkinter
import dlib
import numpy as np
import cv2
import os
...
class FaceRegister:
    def __init__(self):
        ...
        self.font_title = tkFont.Font(family='Montserrat', size=20, weight='bold')
        self.font_step_title = tkFont.Font(family='Montserrat', size=15, weight='bold')
        self.font_warning = tkFont.Font(family='Montserrat', size=15, weight='bold')
    ...
    def gui_clear_data(self):
        # _____________, __ "/data_faces_from_camera/person_x/"...
    ...
    def pre_work_mkdir(self):
        # _____ / Create folders to save face images and csv
    ...
    def check_existing_faces_cnt(self):
        if os.listdir("data/data_faces_from_camera/"):
            # ______________ / Get the order of latest person
    ...
    # FPS / Update FPS of Video stream
    def update_fps(self):
        now = time.time()
        # ____ fps / Refresh fps per second
    ...
    def create_face_folder(self):
        ...
        logging.info("\n%-40s %s", "________ / Create folders:", self.current_face_dir)
        ...
        if self.face_folder_created_flag:
            if self.current_frame_faces_cnt == 1:
                if not self.out_of_range_flag:
                    ...
                    logging.info("%-40s %s/img_face_%s.jpg", "____ / Save into:",
